    ...
    return <>
        <div className="grid grid-cols-3 md:grid-cols-4">
            <div className="md:col-span-1 col-span-3 flex justify-center items-center flex-col">
                <img src={filmChoice.hinhAnh} onError={(e) => {
                    ...
                    e.target.src = "https://picsum.photos/200/300"
                     ...
                     width={170}
                     height={200}/>
                <h3 className='text-lg mt-3 font-bold text-center'>{filmChoice.tenPhim}</h3>
            </div>
            <Form
            ...
            >
                ...
                <Form.Item label="Cụm rạp">
                    <Select
                        options={state.arrSubCinema?.map((rap, index) => ({label: rap.tenCumRap, value: rap.maCumRap}))}
                ...
                <Form.Item label="Ngày chiếu giờ chiếu">
                    <Space direction="vertical" size={12}>
                        <DatePicker format="DD/MM/YYYY hh:mm:ss" showTime onChange={datePickerOnChange}
                                    onOk={datePickerOnOk}/>
                    </Space>,
                </Form.Item>
                <Form.Item label="Giá vé">
                    <InputNumber min={50000} max={150000} defaultValue={75000} step={1000}
